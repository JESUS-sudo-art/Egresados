...
class PreguntaPolicy
{
    ...
    {
        return $user->hasPermissionTo('preguntas.crear') || $user->hasAnyRole(['Administrador general', 'Administrador de unidad']);
    }
    ...
    {
        return $user->hasPermissionTo('preguntas.eliminar') || $user->hasAnyRole(['Administrador general', 'Administrador de unidad']);
    }
