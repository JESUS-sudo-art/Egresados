...
class CarreraPolicy
{
    ...
    {
        return $user->hasPermissionTo('carreras.crear') || $user->hasAnyRole(['Administrador general', 'Administrador academico']);
    }
    ...
    {
        return $user->hasPermissionTo('carreras.editar') || $user->hasAnyRole(['Administrador general', 'Administrador academico']);
    }
    ...
    {
        return $user->hasPermissionTo('carreras.eliminar') || $user->hasRole('Administrador general');
    }
